...
$MESS["SALE_HPS_YANDEX_CHECKOUT_HTTP_STATUS_401"] = "Ошибка аутентификации. Неверный идентификатор вашего аккаунта в Яндекс.Кассе или секретный ключ. Проверьте настройки подключения платежной системы";
$MESS["SALE_HPS_YANDEX_CHECKOUT_HTTP_STATUS_OAUTH_401"] = "Ошибка аутентификации. Невалидный AppOAuth-токен: истек срок жизни токена или токен был отозвал через Яндекс.Паспорт. Запросите токен заново";
...
$MESS["SALE_HPS_YANDEX_CHECKOUT_ERROR_FISCALIZATION_ENABLE"] = "Включена фискализация чеков. Необходимо отключить фискализацию чеков в личном кабинете Яндекс.Кассы";
$MESS["SALE_HPS_YANDEX_CHECKOUT_ERROR_PAYMENT_METHOD_NOT_SUPPORT"] = "Способ оплаты \"#PAYMENT_METHOD#\" не поддерживается. Необходимо обратиться в Яндекс.Кассу";
...
$MESS["SALE_HPS_YANDEX_CHECKOUT_RESPONSE_ERROR_IDENTIFICATION_REQUIRED"] = "Превышены ограничения на платежи для кошелька в Яндекс.Деньгах.";
