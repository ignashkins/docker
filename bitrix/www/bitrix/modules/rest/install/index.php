...
class rest extends CModule
{
	...
	function InstallDB($arParams = array())
	{
		...
		{
			$eventManager->registerEventHandler("rest", "onRestCheckAuth", "rest", "\\Bitrix\\Rest\\AppOAuth\\Auth", "onRestCheckAuth");
		}
	...
	function UnInstallDB($arParams = array())
	{
		...
		$eventManager->unRegisterEventHandler("rest", "onRestCheckAuth", "rest", "\\Bitrix\\Rest\\AppOAuth\\Auth", "onRestCheckAuth");
